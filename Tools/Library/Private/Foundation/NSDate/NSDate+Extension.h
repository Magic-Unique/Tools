...
/** 举例当前的时间间隔描述 */
@property (nonatomic, strong, readonly) NSString *timeIntervalDescription;//距离当前的时间间隔描述

/** 精确到分钟的日期描述 */
@property (nonatomic, strong, readonly) NSString *minuteDescription;

/** 标准格式化时间 */
@property (nonatomic, strong, readonly) NSString *formattedTime;

/** 格式化日期描述 */
@property (nonatomic, strong, readonly) NSString *formattedDateDescription;
